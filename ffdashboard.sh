#!/usr/bin/env bash
### Created by Peter Forret ( pforret ) on 2022-11-07
...
readonly script_created="2022-11-07"
...
Option:usage() {
  ...
  IO:print "Purpose : ${txtInfo}Firefox dashboard showing URLs in a loop${txtReset}"
